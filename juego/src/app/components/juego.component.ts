    ...
    <div class="max-w-4xl mx-auto p-4">
      ...
      <div class="mb-6 p-4 bg-white rounded-lg shadow">
        <h2 class="text-2xl font-bold text-indigo-700">
          {{ gameService.materiaSeleccionada() }} - {{ gameService.competenciaActual()?.nombre }}
        </h2>
      ...
      @if (!gameService.mostrarFeedback() && preguntaActual()) {
        <div class="p-6 bg-white rounded-xl shadow-lg">
          ...
          <div class="mb-4 text-sm text-gray-500 font-semibold">
            Pregunta {{ gameService.preguntaActual() + 1 }} de {{ totalPreguntas() }}
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            @for (opcion of preguntaActual()!.opciones; track $index) {
              <button 
                class="opcion-btn bg-gray-100 p-4 rounded-lg cursor-pointer hover:bg-indigo-100 hover:border-indigo-400 border-2 border-transparent transition-all duration-200 text-left font-medium"
        ...
        <div class="mt-6 p-6 bg-white rounded-lg shadow-lg text-center">
          <div class="mb-4">
            @if (gameService.ultimaRespuestaCorrecta()) {
              ...
              <img 
                src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/7344f9e9-92b0-4866-83ec-e516c26697d5.png" 
                alt="Correcto" 
              ...
              <p class="text-lg text-gray-700 mb-4">
                La respuesta correcta era: <strong class="text-indigo-700">{{ getRespuestaCorrecta() }}</strong>
              </p>
              <img 
                src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/44310e98-8556-42b5-bd9e-948d44db06f6.png" 
                alt="Incorrecto" 
                class="w-20 h-20 mx-auto mb-4"
              />
            }
          ...
          <button 
            class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-bold transition-colors"
            (click)="siguiente()"
          >
