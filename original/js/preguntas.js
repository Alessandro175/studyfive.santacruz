  ...
  1: {
    Inglés: [
      [
        ...
        },
        {
          ...
          competencia: "Se comunica oralmente en inglés como lengua extranjera",
          pregunta:
            "How do you say 'buenas noches' (al despedirse) in English?",
        ...
        },
        {
          ...
          competencia: "Se comunica oralmente en inglés como lengua extranjera",
          pregunta:
            "If someone says 'Fine, thanks and you?', what do you answer?",
      ...
      [
        // COMPETENCIA 3
        {
          ...
          explicacion:
            "In my school there is a library significa En mi colegio hay una biblioteca.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my school there is a playground significa En mi colegio hay un patio de juegos.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my classroom there is a blackboard significa En mi aula hay una pizarra.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my classroom there are tables and chairs significa En mi aula hay mesas y sillas.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my school there is a bathroom significa En mi colegio hay un baño.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my school there is a laboratory significa En mi colegio hay un laboratorio.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my classroom there is a teacher significa En mi aula hay un profesor.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my school there is an art room significa En mi colegio hay una sala de arte.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my classroom there is a window significa En mi aula hay una ventana.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my school there is a dining room significa En mi colegio hay un comedor.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my classroom there is a clock significa En mi aula hay un reloj.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my school there is a sports field significa En mi colegio hay una cancha.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my classroom there is a map significa En mi aula hay un mapa.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my school there is a gym significa En mi colegio hay un gimnasio.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my classroom there is a projector significa En mi aula hay un proyector.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my school there is an infirmary significa En mi colegio hay una enfermería.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my classroom there are backpacks significa En mi aula hay mochilas.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my school there is an office significa En mi colegio hay una oficina.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my classroom there are lights significa En mi aula hay luces.",
        },
        {
          dificultad: "facil",
          competencia: "Escribe textos breves en inglés",
          ...
          explicacion:
            "In my school there is a music room significa En mi colegio hay una sala de música.",
        },
      ...
      [
        ...
        },
        {
          ...
          explicacion:
            "Police Station significa estación de policía en inglés.",
        },
        {
          dificultad: "difil",
          competencia: "Escribe textos breves en inglés",
    ...
    Matemática: [
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "María tiene 2 lápices y compra 2 más. ¿Cuántos lápices tiene?",
        opciones: ["3", "4", "5", "6"],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "Si tienes 6 caramelos y te dan 3 más, ¿cuántos caramelos tienes?",
        opciones: ["8", "9", "10", "11"],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "Si tienes 1 caramelo y compras 7 más, ¿cuántos caramelos tienes?",
        opciones: ["7", "8", "9", "10"],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "Laura tiene 4 globos y su amigo le da 9 más. ¿Cuántos tiene?",
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "Si tienes 7 caramelos y compras 6 más, ¿cuántos caramelos tienes?",
        opciones: ["12", "13", "14", "15"],
        respuestaCorrecta: 1,
...

      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "Pedro tiene 5 caramelos, compra 2 más, luego recibe 4 de su amigo, pero come 6 y regala 1. ¿Cuántos caramelos tiene ahora?",
        opciones: ["4", "3", "2", "5"],
        respuestaCorrecta: 0,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "Ana tenía 10 lápices, le dieron 3, luego perdió 5 y después encontró 2 más. ¿Cuántos lápices tiene ahora?",
        opciones: ["9", "10", "8", "7"],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "En una granja hay 6 vacas, llegan 5 más, se venden 3, luego llegan 4 terneros. ¿Cuántos animales hay en total?",
        opciones: ["11", "12", "13", "14"],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "Luis tiene 8 galletas, compra 7, regala 4, encuentra 2 más y luego pierde 1. ¿Cuántas galletas tiene?",
        opciones: ["10", "12", "11", "9"],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "María tenía 9 flores, recibe 5 más, regala 3, compra 4 y da 2. ¿Cuántas flores tiene ahora?",
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "En una fiesta había 7 niños, llegaron 6 más, se fueron 5, llegaron 4 y luego se fueron 2. ¿Cuántos niños quedaron?",
        opciones: ["10", "11", "9", "8"],
        respuestaCorrecta: 0,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "Pedro tenía 4 canicas, compra 5, regala 3, encuentra 2 y pierde 1. ¿Cuántas canicas tiene ahora?",
        opciones: ["6", "7", "8", "9"],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "Juan tenía 12 chocolates, come 4, recibe 3, regala 5 y luego compra 2 más. ¿Cuántos chocolates tiene ahora?",
        opciones: ["7", "8", "9", "10"],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "En un parque había 5 bicicletas, llegaron 7 más, se retiraron 4, llegaron 3 y se llevaron 2. ¿Cuántas bicicletas hay?",
        opciones: ["8", "9", "10", "11"],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "Luis tenía 6 caramelos, recibe 4, regala 3, compra 5 más y come 2. ¿Cuántos caramelos tiene?",
        opciones: ["9", "10", "11", "12"],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "Si tienes 10 juguetes, compras 3 más, regalas 4, recibes 2 y pierdes 1. ¿Cuántos juguetes quedan?",
        opciones: ["10", "11", "12", "13"],
        respuestaCorrecta: 0,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "María tenía 8 chocolates, recibió 5 más, regaló 6, compró 2 y luego perdió 1. ¿Cuántos chocolates tiene?",
        opciones: ["7", "8", "9", "10"],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "En un huerto hay 9 manzanas, llegan 4 más, se comen 5, caen 2 y luego se recogen 1. ¿Cuántas manzanas hay?",
        opciones: ["10", "11", "12", "13"],
        respuestaCorrecta: 0,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "Juan tenía 14 canicas, le dieron 2 más, regaló 5, encontró 1 y perdió 3. ¿Cuántas tiene ahora?",
        opciones: ["8", "9", "10", "11"],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        competencia: "Resuelve problemas de cantidad",
        pregunta:
          "Si tienes 16 caramelos, comes 5, recibes 4, regalas 3 y luego compras 2 más. ¿Cuántos caramelos tienes?",
        opciones: ["12", "13", "14", "15"],
        respuestaCorrecta: 2,
    ...
    Comunicación: [
      {
        ...
        respuestaCorrecta: 3,
        explicacion:
          "El signo de interrogación se usa al inicio y al final de una pregunta.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 3,
        explicacion:
          "Una oración expresa una idea completa con sujeto y predicado.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La coma separa palabras u oraciones breves en una enumeración.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "El texto argumentativo defiende una idea o punto de vista.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué parte de la historia presenta el problema del personaje?",
        opciones: ["Final", "Inicio", "Nudo", "Epílogo"],
        respuestaCorrecta: 2,
        explicacion:
          "El nudo es donde ocurre el conflicto o problema en el texto narrativo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Una palabra que nombra acciones",
          "Una palabra que nombra cosas",
          "Una palabra que describe al sustantivo",
          "Una palabra que une frases",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "El adjetivo indica cómo es el sustantivo (grande, rojo, rápido, etc.).",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Los textos instructivos explican cómo hacer algo paso a paso.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La exclamación expresa emoción o sorpresa, y se marca con ¡!",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El sujeto es quien realiza o recibe la acción en una oración.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Contento es un sinónimo de alegre, ya que expresa felicidad.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La fábula es un texto narrativo breve con enseñanza o moraleja.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 3,
        explicacion:
          "El desenlace es el final, donde se resuelve el conflicto.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Leer muy rápido",
          "Saltar palabras",
          "Leer con ritmo, entonación y comprensión",
          "Decir palabras al azar",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "La fluidez incluye ritmo, entonación y comprensión lectora.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Perro es un sustantivo común porque no nombra algo específico.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué texto se escribe para expresar sentimientos personales?",
        opciones: ["Noticia", "Receta", "Poema", "Instructivo"],
        respuestaCorrecta: 2,
        explicacion:
          "El poema permite expresar emociones y sentimientos con belleza.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Leer sin pensar",
          "Leer una sola vez",
          "Prestar atención y entender las ideas",
          "Leer solo el título",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Comprender implica entender el contenido, no solo leer palabras.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
    ...
    "Ciencia y Tecnología": [
      {
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Las plantas necesitan agua, luz solar, aire y tierra para crecer sanas y fuertes.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Las arañas tienen 8 patas. Son diferentes a los insectos que tienen 6 patas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué aparato usamos para hablar con personas que están lejos?",
        opciones: ["Teléfono", "Televisión", "Radio", "Computadora"],
        respuestaCorrecta: 0,
        explicacion:
          "El teléfono nos permite hablar con personas que están en otros lugares.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "Del grifo sale agua, que es muy importante para beber, cocinar y lavar.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Los peces viven en el agua, tienen aletas para nadar y branquias para respirar.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La televisión nos permite ver programas, películas y noticias.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Los pájaros tienen alas que les permiten volar por el cielo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "Usamos los ojos para ver todo lo que está a nuestro alrededor.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El refrigerador mantiene fría la comida para que no se dañe.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El perro es un mamífero porque tiene pelo y toma leche de su mamá cuando es bebé.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Durante la noche vemos la luna, que nos da luz cuando está oscuro.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El papel se puede reciclar para hacer nuevos libros y cuadernos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "Las raíces están bajo la tierra y ayudan a la planta a obtener agua y nutrientes.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál es la fuente de energía más importante para la Tierra?",
        opciones: ["Luna", "Agua", "Viento", "Sol"],
        respuestaCorrecta: 1,
        explicacion:
          "El Sol es la fuente de energía más importante, nos da luz y calor.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Las abejas hacen miel en sus colmenas y es muy dulce y nutritiva.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "El agua puede ser líquida, sólida (hielo) o gaseosa (vapor), pero amarillo es un color.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La lavadora nos ayuda a limpiar nuestra ropa con agua y jabón.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La gallina pone huevos que podemos comer y de donde nacen los pollitos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Las pilas o baterías dan energía a la linterna para que pueda dar luz.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La Tierra es el planeta donde vivimos, es redonda y gira alrededor del Sol.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Usamos la nariz para oler las flores, la comida y muchas otras cosas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál de estos aparatos nos ayuda a comunicarnos por internet?",
        opciones: ["Horno", "Computadora", "Lavadora", "Refrigerador"],
        respuestaCorrecta: 1,
        explicacion:
          "La computadora nos permite usar internet para comunicarnos y aprender.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El león es conocido como el rey de la selva porque es fuerte y valiente.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El carro es un medio de transporte que nos ayuda a movernos de un lugar a otro.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El corazón bombea la sangre por todo nuestro cuerpo para mantenernos vivos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Los metales como el cobre conducen la electricidad, por eso se usan en los cables.",
      },
    ],
    "Personal Social": [
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Lima es la capital del Perú, donde vive el presidente y están las oficinas más importantes del gobierno.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La bandera del Perú tiene dos franjas rojas y una blanca en el medio.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué valor practicamos cuando decimos 'por favor' y 'gracias'?",
        opciones: ["Honestidad", "Cortesía", "Valentía", "Justicia"],
        respuestaCorrecta: 1,
        explicacion:
          "La cortesía es ser educado y respetuoso con otras personas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La vicuña es el animal nacional del Perú, aparece en el escudo nacional.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué debemos hacer cuando vemos a alguien que necesita ayuda?",
        opciones: ["Ignorarlo", "Reírnos", "Ayudarlo", "Alejarnos"],
        respuestaCorrecta: 2,
        explicacion:
          "Debemos ayudar a las personas que lo necesitan, eso se llama solidaridad.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El Perú está en América del Sur, junto con otros países como Brasil y Argentina.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El ceviche es un plato típico peruano hecho con pescado y limón.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Desobedecerlos",
          "Obedecerlos y amarlos",
          "Gritarles",
          "Ignorarlos",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Respetar a nuestros padres significa obedecerlos, amarlos y ser agradecidos con ellos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El Océano Pacífico baña toda la costa peruana, desde Tumbes hasta Tacna.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El 28 de julio celebramos las Fiestas Patrias, el día de la independencia del Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El Perú tiene tres regiones naturales: costa, sierra y selva.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La honestidad es decir siempre la verdad, incluso cuando es difícil.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El río Amazonas es el más largo y nace en el Perú, en la región de Arequipa.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Ser generosos significa compartir lo que tenemos con otros niños.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Los Incas fueron la civilización más importante del Perú, construyeron Machu Picchu.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Loreto es el departamento más grande del Perú y está en la selva amazónica.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Debemos botar la basura en el tacho para mantener limpio nuestro ambiente.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El escudo nacional es un símbolo patrio que representa al Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Ser responsable significa cumplir con nuestros deberes y tareas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El algodón se cultiva en la costa peruana gracias al clima cálido.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La paciencia es saber esperar nuestro turno sin desesperarnos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Nuestro himno se llama 'Himno Nacional' y empieza con 'Somos libres'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Ser obedientes significa seguir las reglas y normas de la escuela.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La marinera es un baile típico peruano muy elegante y hermoso.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La sierra es la región de las montañas, donde están los Andes.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La humildad es reconocer nuestros errores y pedir perdón.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El Lago Titicaca está entre Perú y Bolivia, es el lago navegable más alto del mundo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Debemos saludar también, eso muestra respeto y buena educación.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La quena es un instrumento musical típico del Perú, hecho de caña.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Odiar otros países",
          "Cuidar y respetar el Perú",
          "Irse del país",
          "Criticar todo",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Amar a nuestra patria significa cuidar y respetar el Perú, nuestro país.",
      },
    ],
    "Arte y Cultura": [
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El lápiz nos ayuda a dibujar formas y líneas con facilidad.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "La pandilla es una danza alegre de la región amazónica del Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La guitarra es un instrumento de cuerdas que se toca con los dedos o pua.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El cielo suele representarse con el color azul en los dibujos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "En el teatro se usan la voz y el cuerpo para expresar emociones.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El rojo es uno de los colores principales de la bandera del Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Un baile",
          "Una canción",
          "Una imagen hecha con colores",
          "Un instrumento",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Una pintura es una forma de arte visual creada con colores.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 3,
        explicacion:
          "La Diablada es una danza típica del altiplano peruano, especialmente en Puno.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La zampoña es un instrumento típico de la sierra del Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          "Dormir mucho",
          "Jugar fútbol",
          "Inventar y crear cosas",
          "Repetir lo mismo",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "La creatividad es imaginar y crear algo nuevo y original.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Los instrumentos de percusión como el cajón dan ritmo a la música.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Los caporales son una danza festiva del altiplano peruano.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué forma de arte usamos para contar historias con imágenes?",
        opciones: ["Pintura", "Dibujo", "Teatro", "Cine"],
        respuestaCorrecta: 1,
        explicacion:
          "El dibujo permite representar historias o escenas con imágenes.",
      },
    ],
  },
  2: {
    ...
    Comunicación: [
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Los sustantivos abstractos nombran ideas, sentimientos o cualidades que no se pueden percibir con los sentidos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El texto argumentativo busca convencer al lector con ideas y argumentos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "En los poemas predomina la función expresiva porque se transmiten emociones y sentimientos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Un conector causal indica la causa de una acción, como 'porque', 'ya que'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La denotación es el significado literal o objetivo de una palabra.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "El volumen al hablar",
          "El orden de las palabras",
          "El ritmo de una oración",
          "El tono al hablar que da sentido",
        ],
        respuestaCorrecta: 3,
        explicacion:
          "La entonación es el tono o modulación que damos al hablar y afecta el significado.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Leer en voz alta",
          "Copiar ideas",
          "Decir lo que está escrito",
          "Sacar conclusiones a partir de lo leído",
        ],
        respuestaCorrecta: 3,
        explicacion:
          "Inferir es obtener una idea que no está dicha directamente en el texto.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Llover a cántaros es una metáfora, por lo tanto, lenguaje figurado.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Presenta datos y explica un tema",
          "Cuenta una historia",
          "Tiene diálogos",
          "Da opiniones",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "El texto expositivo informa y explica un tema con claridad.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El narrador protagonista cuenta los hechos desde su perspectiva, usando 'yo'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Palabras de diferentes temas",
          "Palabras sin relación",
          "Palabras que riman",
          "Palabras relacionadas por su significado",
        ],
        respuestaCorrecta: 3,
        explicacion:
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El lenguaje formal se caracteriza por su claridad, precisión y respeto.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Explica un tema",
          "Argumenta una idea",
          "Cuenta hechos reales o ficticios",
          "Describe objetos",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "El texto narrativo cuenta una historia con personajes, lugar y tiempo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Describe a un verbo, adjetivo u otro adverbio",
          "Es un pronombre",
          "Sustituye a un sustantivo",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "El adverbio modifica a un verbo, adjetivo u otro adverbio.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "La más corta",
          "La que resume el tema central",
          "La que tiene un dibujo",
        ],
        respuestaCorrecta: 2,
      ...
      },
      {
        ...
        opciones: [
          "Tiene un solo verbo",
          "Tiene dos o más oraciones simples",
          "Es interrogativa",
          "Solo tiene sujeto",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "La oración compuesta tiene dos o más oraciones simples unidas por conectores.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La metáfora es una forma de decir algo por medio de otra imagen sin usar 'como'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Persuadir es convencer a alguien con razones o sentimientos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Los textos discontinuos presentan información de forma no lineal, como gráficos o mapas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Solo el mensaje",
          "Lugar y tiempo donde ocurre la comunicación",
          "Solo el canal",
          "Solo el emisor y receptor",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "El contexto comunicativo es la situación, lugar y tiempo en el que ocurre la comunicación.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          ...
          "La unión entre las ideas del texto",
          "La cantidad de párrafos",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "La cohesión textual se refiere a cómo las partes del texto están conectadas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "La que se escribe en mayúscula",
          "La que tiene tilde siempre",
          "La que se pronuncia con más fuerza",
          "La que está al final",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "La sílaba tónica es la que lleva la mayor fuerza de pronunciación.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Un resumen",
          "Una opinión",
          "Relato de hechos en orden cronológico",
          "Una carta formal",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "La crónica narra hechos reales en orden cronológico con opinión del autor.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          "Indica duda",
          "Expresa una orden o ruego",
          "Describe acciones pasadas",
          "Muestra deseos",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "El modo imperativo se usa para dar órdenes o hacer pedidos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "La noticia es un texto informativo que comunica hechos actuales.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          "Significado literal",
          "Significado simbólico o figurado",
          "Significado de diccionario",
          "Significado técnico",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "El lenguaje connotativo usa palabras con sentido figurado o simbólico.",
      },
    ],
    "Ciencia y Tecnología": [
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Las raíces permiten absorber el agua y nutrientes del suelo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Cuando el agua se congela se convierte en hielo, que es su estado sólido.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El Sol es una estrella que proporciona luz y calor al planeta.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "El olfato es el sentido que permite detectar olores con la nariz.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El cerebro es el órgano que controla los pensamientos y movimientos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Los mamíferos nacen del vientre y se alimentan de leche materna.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Agua, tierra y sombra",
          "Luz, agua y dióxido de carbono",
          "Agua, fuego y oxígeno",
          "Solo luz solar",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "La fotosíntesis ocurre con agua, luz solar y dióxido de carbono.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Usamos el sentido de la vista a través de los ojos para ver.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Los músculos y huesos trabajan juntos para mover el cuerpo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Cuál es el proceso donde los alimentos se transforman en energía?",
        opciones: ["Respiración", "Digestión", "Evaporación", "Crecimiento"],
        respuestaCorrecta: 1,
        explicacion:
          "La digestión convierte los alimentos en nutrientes y energía.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Las plantas eléctricas producen energía para las ciudades.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 3,
        explicacion:
          "El agua es esencial para la vida y la consumimos diariamente.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Saturno es famoso por sus grandes anillos de hielo y roca.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El Sol produce energía solar que llega a la Tierra en forma de luz y calor.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El sistema digestivo transforma los alimentos en energía.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 3,
        explicacion:
          "El cobre es un excelente conductor eléctrico y se usa en cables.",
      },
    ],
    "Personal Social": [
      {
    ...
    "Arte y Cultura": [
      {
        ...
        opciones: [
          ...
          "Una creación artística que expresa ideas o emociones",
          "Una tarea del colegio",
          "Una película de acción",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Una obra de arte es una creación artística que busca expresar ideas, emociones o belleza.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El teatro es una forma de arte escénico que representa historias frente a una audiencia.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La flauta es un instrumento de viento porque produce sonido al soplar aire en ella.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Una danza moderna",
          "Un estilo de teatro",
          "Una danza tradicional con raíces africanas",
          "Una técnica de pintura",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "La danza negra o afroperuana tiene raíces africanas y es típica de la costa del Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          "Imita la realidad",
          "Usa formas reales",
          "No representa figuras reales",
          "Es una danza tradicional",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "El arte abstracto no representa figuras reales, sino formas y colores libres.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Los Caporales son una danza tradicional boliviana muy popular también en Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La quena es un instrumento de viento tradicional de los Andes.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Los colores cálidos como el rojo, naranja y amarillo transmiten alegría y energía.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Pintura sobre papel",
          "Pintura en tela",
          "Pintura hecha en una pared",
          "Pintura en cerámica",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Una pintura mural es aquella que se realiza directamente sobre una pared.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué baile peruano representa el cortejo del gallo y la gallina?",
        opciones: ["Marinera", "Huaylas", "Tondero", "Festejo"],
        respuestaCorrecta: 0,
        explicacion:
          "La marinera representa el galanteo entre el hombre y la mujer, como el gallo y la gallina.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Un tipo de canto",
          "Una pintura",
          "Una forma de arte tridimensional",
          "Una danza",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "La escultura es una forma de arte que se realiza en tres dimensiones como piedra, madera o metal.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Un tipo de pintura",
          "Una secuencia de movimientos de baile",
          "Una melodía",
          "Un instrumento musical",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "La coreografía es la organización de los pasos y movimientos en una danza.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Los colores fríos como azul, verde y violeta transmiten calma y serenidad.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El ritmo es la organización de los sonidos y silencios en el tiempo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "En el carnaval se usa arte visual como disfraces y escénico como danzas y música.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El festejo representa la alegría y tradición de la cultura afroperuana.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Una tabla donde se mezclan colores",
          "Una hoja para pintar",
          "Un dibujo",
        ],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        opciones: [
          "Pintura de otra persona",
          "Dibujo de un paisaje",
          "Pintura de uno mismo",
          "Foto grupal",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "El autorretrato es una representación de uno mismo hecha por el artista.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Arte moderno",
          "Arte de élite",
          "Arte de las comunidades y pueblos",
          "Arte de museos",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "El arte popular se hace en las comunidades y representa sus costumbres y creencias.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "Los Shapis representan los carnavales de los Andes con colorido y alegría.",
      },
    ],
  },
  3: {
    Inglés: [
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "'She goes' es correcto porque el sujeto es tercera persona singular.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
    ...
    Matemática: [
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué número representa el valor posicional de las centenas en 482?",
        opciones: ["2", "4", "8", "400"],
        respuestaCorrecta: 3,
        explicacion:
          "En 482, el 4 está en la posición de centenas: 4 x 100 = 400.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La secuencia aumenta de 3 en 3, el número faltante es 12.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Cuál es el número más pequeño de esta lista: 245, 209, 310, 198?",
    ...
    Comunicación: [
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El sujeto es quien realiza la acción, en este caso 'el perro'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Las rimas son palabras que tienen sonidos finales similares.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El cuento es un texto narrativo, porque cuenta una historia.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          ...
          "Una persona",
          "Una palabra que reemplaza al nombre",
          "Un sinónimo",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "El pronombre reemplaza a un sustantivo (como 'él', 'ella').",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          "Un cuento de miedo",
          "Un poema",
          "Un texto con animales que deja una enseñanza",
          "Una receta",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "La fábula es un relato corto con animales y una moraleja.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          "Fin del texto",
          "Que debemos gritar",
          "Que se continúa con otra oración en el mismo párrafo",
          "Una pregunta",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "El punto y seguido se usa para continuar en el mismo párrafo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
    ...
    "Ciencia y Tecnología": [
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El corazón es el órgano que bombea la sangre a todo el cuerpo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
    ...
    "Personal Social": [
      {
        ...
        opciones: [
          ...
          "Un grupo de amigos",
          "Un grupo de personas unidas por lazos de amor y parentesco",
          "Un equipo de fútbol",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "La familia es un grupo de personas que se aman y se cuidan mutuamente.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          "Tener muchos amigos",
          "Parecerse a otros",
          "Conocer y valorar lo que nos hace únicos",
          "No saber quién eres",
        ],
        respuestaCorrecta: 2,
      ...
      },
      {
        ...
        opciones: [
          ...
          "Derecho a participar en la vida del país",
          "Tener muchos juguetes",
          "No respetar las leyes",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "La ciudadanía implica derechos y deberes dentro del país.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Vivir en lugares separados",
          "Pelear todo el tiempo",
          "Vivir juntos respetándonos",
          "Comer mucho",
        ],
        respuestaCorrecta: 2,
      ...
      },
      {
        ...
        opciones: [
          "El que maneja un carro",
          "El jefe de una tienda",
          "La autoridad de un distrito",
          "Un cantante famoso",
        ],
        respuestaCorrecta: 2,
      ...
      },
      {
        ...
        opciones: [
          "Un grupo de animales",
          "Un grupo de personas que viven en un mismo lugar",
          "Una familia",
          "Un grupo escolar",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "La comunidad es un conjunto de personas que conviven en un mismo lugar.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La televisión permite transmitir información a muchas personas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          "Correr",
          "Hablar por teléfono",
          "Mirar ambos lados y usar el cruce peatonal",
          "Cerrar los ojos",
        ],
        respuestaCorrecta: 2,
      ...
      },
      {
        ...
        opciones: [
          "Un futbolista",
          "Un marinero valiente del Perú",
          "Un maestro",
          "Un médico",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Miguel Grau es un héroe nacional por su valentía en la guerra.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          "Un permiso para hacer daño",
          "Una obligación",
          "Algo que podemos exigir para nuestro bienestar",
          "Un castigo",
        ],
        respuestaCorrecta: 2,
      ...
      },
      {
        ...
        opciones: [
          "Reírse de otros",
          "Escuchar, aceptar y valorar a los demás",
          "Gritar siempre",
          "Romper las reglas",
        ],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        opciones: [
          "Porque sí",
          "Porque es un recurso importante para la vida",
          "Porque está de moda",
          "Porque lo dice mi profesor",
        ],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        opciones: [
          "Reírnos",
          "Ignorarlo",
          "Consolarlo o acompañarlo",
          "Hacerle bromas pesadas",
        ],
        respuestaCorrecta: 2,
      ...
      },
      {
        ...
        opciones: [
          "Un dibujo de personas",
          "Un gráfico que representa el territorio del país",
          "Una historieta",
          "Un cuento",
        ],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        opciones: [
          "Una fiesta",
          "Un malentendido o desacuerdo entre personas",
          "Un juego",
          "Un paseo",
        ],
        respuestaCorrecta: 1,
    ...
    "Arte y Cultura": [
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La pandilla es una danza y ritmo típico de la región amazónica del Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "En la selva se usan tambores artesanales hechos con piel de animales.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué danza boliviana es muy conocida y se baila en Perú también?",
        opciones: ["Saya", "Samba", "Cumbia", "Tondero"],
        respuestaCorrecta: 0,
        explicacion:
          "La saya es una danza afroboliviana que también se baila en la región sur del Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          ...
          "Una pintura de uno mismo",
          "Una foto grupal",
          "Un paisaje",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "El autorretrato es una representación que hace una persona de sí misma.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Leonardo da Vinci fue el autor de la famosa pintura 'La Mona Lisa'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La melodía es una sucesión de notas que suenan agradables al oído.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Un paisaje representa montañas, ríos, árboles o el campo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "La pandilla simboliza la cosecha y celebración amazónica.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El marrón se obtiene mezclando varios colores primarios y secundarios.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 0,
        explicacion:
          "La zampoña es un instrumento tradicional andino hecho de cañas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Una danza selvática alegre",
          "Una danza europea",
          "Una marcha militar",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Los Shapis es una danza colorida y alegre de la selva central peruana.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Los colores fríos transmiten calma, como el azul y el verde.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La escultura usa materiales como el barro para formar figuras.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La paleta contiene todos los colores que el artista va a usar.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué danza se baila con trajes coloridos y máscaras en Bolivia?",
        opciones: ["Saya", "Caporales", "Cumbia", "Pandilla"],
        respuestaCorrecta: 1,
        explicacion:
          "Los Caporales es una danza boliviana con trajes brillantes y energía.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué tipo de arte representa ideas con formas sin sentido real?",
        opciones: ["Realismo", "Abstracto", "Costumbrismo", "Cubismo"],
        respuestaCorrecta: 1,
        explicacion:
          "El arte abstracto usa líneas y colores para expresar emociones sin forma definida.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El boceto es un dibujo previo, hecho rápidamente para planificar una obra.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El bongo es un instrumento de percusión más pequeño que el tambor.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El verde es el color complementario del rojo en el círculo cromático.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El costumbrismo muestra las tradiciones y actividades del pueblo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La palizada es una danza amazónica en la que se usan palos rítmicamente.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué instrumento tiene teclas y cuerdas y se toca con los dedos?",
      ...
      },
      {
        ...
        respuestaCorrecta: 3,
        explicacion:
          "Todas las formas geométricas pueden formar patrones artísticos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El bombo es esencial en la danza Caporales por su ritmo fuerte.",
      },
    ],
  },
  4: {
    Inglés: [
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "En presente simple con 'she', el verbo lleva 's': 'She plays football'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "'We are eating' es la forma correcta en presente continuo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué pronombre se usa para un animal (cuando no se sabe su sexo)?",
      ...
      },
      {
        ...
        opciones: [
          ...
          "My mother well cooks",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "'Well' es el adverbio correcto, y con 'she' usamos 'cooks'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Ella no le gusta las manzanas",
          "Ella no come manzanas",
          "Ella no quiere manzanas",
          "Ella no tiene manzanas",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "La oración en negativo con 'doesn’t' significa que no le gusta.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "La pregunta correcta en presente simple es 'Where do you live?'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Cuál es el adjetivo correcto en 'The elephant is ___ than the dog'?",
      ...
      },
      {
        ...
        opciones: [
          ...
          "Ella está peinando su cabello",
          "Ella está cepillando sus dientes",
          "Ella está vistiéndose",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "La frase 'She is brushing her teeth' significa 'Ella está cepillando sus dientes'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "'I want to learn English' se traduce como 'Quiero aprender inglés'.",
      },
    ],
    Matemática: [
      {
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Si tengo 5 cajas con 6 naranjas cada una, ¿cuántas tengo en total?",
    ...
    Comunicación: [
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La oración '¿Dónde vives?' es una pregunta, por eso es interrogativa.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Cuál es el sujeto en la oración: 'El gato duerme en la silla'?",
      ...
      },
      {
        ...
        respuestaCorrecta: 3,
        explicacion:
          "'Bolbora' no existe, la forma correcta es 'bóveda' o similar.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Una receta indica pasos, por eso es un texto instructivo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "'Árbol' tiene tilde por ser palabra grave terminada en consonante no n/s.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "'Papá' es una palabra aguda terminada en vocal, lleva tilde.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La rima ocurre cuando dos palabras tienen sonidos finales similares.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué signo final lleva esta oración: '¡Qué divertido estuvo el juego!'?",
        opciones: ["¿", ".", "!", ","],
        respuestaCorrecta: 2,
    ...
    "Ciencia y Tecnología": [
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Un adulto tiene 206 huesos. Los bebés nacen con más huesos, pero algunos se unen al crecer.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Agua y tierra",
          "Luz solar, agua y aire",
          "Solo agua",
          "Solo luz solar",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Las plantas necesitan luz solar, agua y dióxido de carbono del aire para hacer su comida.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Júpiter es el planeta más grande. Es tan grande que podrían caber más de 1,000 Tierras dentro de él.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Los camaleones pueden cambiar de color para comunicarse y camuflarse con su entorno.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuántos días tarda la Tierra en dar una vuelta completa al Sol?",
        opciones: ["300 días", "365 días", "400 días", "200 días"],
        respuestaCorrecta: 1,
        explicacion:
          "La Tierra tarda 365 días (un año) en completar una órbita alrededor del Sol.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Usamos el sentido del oído para escuchar sonidos. Los oídos están en nuestra cabeza.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La sangre es de color rojo porque contiene glóbulos rojos que llevan oxígeno por el cuerpo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "La palanca, la rueda y el tornillo son máquinas simples que nos ayudan a mover cosas pesadas más facilmente.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Cuando el agua está muy fría se convierte en hielo, que es su estado sólido.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El corazón es como una bomba que envía sangre a todo nuestro cuerpo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Las arañas tienen 8 patas. Esto las hace diferentes de los insectos, que tienen 6 patas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Respiramos oxígeno del aire. Nuestros pulmones toman el oxígeno que necesitamos para vivir.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La Luna es el satélite natural de la Tierra. Gira alrededor de nuestro planeta.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Las raíces están bajo la tierra y absorben agua y nutrientes del suelo para la planta.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El cobre es muy usado para hacer monedas porque no se oxida facilmente y es resistente.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El microscopio hace que las cosas muy pequeñas se vean grandes para poder estudiarlas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El agua se congela y se convierte en hielo cuando la temperatura llega a 0 grados Celsius.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La ballena azul es el animal más grande que existe en la Tierra, incluso más grande que los dinosaurios.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La Tierra tiene forma redonda, como una pelota, aunque no es perfectamente esférica.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Un adulto tiene 32 dientes: 16 en la parte de arriba y 16 en la parte de abajo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El ornitorrinco es un animal muy especial que pone huevos como las aves, pero da leche como los mamíferos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El Sol nos da luz y calor. Sin el Sol, no habría vida en la Tierra.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El cerebro está en nuestra cabeza y nos ayuda a pensar, recordar y controlar nuestro cuerpo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Las mariposas tienen 4 alas: dos alas grandes arriba y dos alas más pequeñas abajo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Aunque vive en el agua, la ballena es un mamífero porque respira aire y alimenta a sus bebés con leche.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La atmósfera es la capa de aire que rodea la Tierra y contiene el oxígeno que respiramos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La retina está en el fondo del ojo y tiene células especiales que detectan la luz y los colores.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El fémur es el hueso de la pierna que va desde la cadera hasta la rodilla. Es el más largo del cuerpo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El termómetro nos dice qué tan caliente o frío está algo, como cuando tenemos fiebre.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Los paneles solares convierten la luz del Sol en electricidad que podemos usar en nuestras casas.",
      },
    ],
    "Personal Social": [
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué rama del poder del Estado se encarga de hacer las leyes?",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El alcalde es la autoridad que gobierna la ciudad o distrito.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          "Reglas escolares",
          "Beneficios solo para adultos",
          "Normas que protegen a los niños",
          "Obligaciones laborales",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Los derechos del niño protegen su bienestar y desarrollo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Una comunidad es un grupo de personas que comparten un espacio y normas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "La independencia y el amor por la patria",
          "La monarquía española",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Nuestra bandera simboliza independencia y amor por la patria.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      // 20 preguntas más a continuación...
      {
        ...
        opciones: [
          "Persona que da órdenes sin motivo",
          "Persona que se encarga de cuidar y organizar una comunidad",
      ...
      },
      {
        ...
        opciones: [
          "Un virrey",
          "Un sacerdote",
          "Un líder indígena que luchó contra los abusos coloniales",
          "Un español",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Túpac Amaru II lideró una rebelión indígena en el siglo XVIII.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Reglas que ayudan a vivir en armonía",
          "Obligaciones que solo aplican en el colegio",
          "Leyes para castigar",
          "Reglas de un juego",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "Son reglas que permiten una buena convivencia entre personas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "El poder de un rey",
          "Un sistema donde todos opinan y deciden",
          "Un sistema de castigos",
          "Una dictadura",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "La democracia es un sistema donde el pueblo participa en las decisiones.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Una orden",
          "Una obligación",
          "Algo que puedo exigir y disfrutar",
          "Una ley impuesta",
        ],
        respuestaCorrecta: 2,
      ...
      },
      {
        ...
        opciones: [
          ...
          "Para evitar peleas",
          "Porque todos tienen derecho a conservar su cultura",
          "Porque son extrañas",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Respetar otras culturas es parte de una convivencia sana.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Hacen leyes nacionales",
          "Organizan la ciudad, recogen basura y mejoran servicios",
          "Manejan las escuelas",
          "Protegen las fronteras",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Las municipalidades se encargan del buen funcionamiento de la ciudad.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El respeto y la solidaridad fortalecen la convivencia pacífica.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Olvidar las raíces",
          "Costumbres, tradiciones y valores de una comunidad",
          "Solo la vestimenta",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "La identidad cultural incluye todo lo que caracteriza a una comunidad.",
      },
    ],
    "Arte y Cultura": [
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué danza afroperuana representa la resistencia cultural de los esclavos traídos al Perú?",
        opciones: ["Marinera", "Festejo", "Huayno", "Santiago"],
        respuestaCorrecta: 1,
        explicacion:
          "El festejo es una danza afroperuana que representa la cultura de los esclavos africanos en la costa del Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Un baile de los incas",
          "La autoridad del capataz en las haciendas",
          "Una fiesta de la selva",
          "Un baile ceremonial del altiplano",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "El Caporal representa al capataz que vigilaba a los esclavos, por eso su vestimenta y actitud fuerte.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La danza de los Caporales tiene origen en Bolivia, específicamente en La Paz.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál es una danza representativa de la cultura negra en el Perú?",
        opciones: ["Valicha", "Diablada", "Son de los diablos", "Shapis"],
        respuestaCorrecta: 2,
        explicacion:
          "El Son de los Diablos es una danza afroperuana con máscaras y pasos teatrales.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué elementos se usan en el teatro escolar para representar personajes?",
        opciones: [
          "Cartulina y crayones",
          "Máscaras, vestuario y escenografía",
          "Tizas y borrador",
          "Solo un guion",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "El teatro usa máscaras, vestuario y escenografía para dar vida a los personajes.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Practicar educación física",
          "Desarrollar expresión artística y corporal",
          "Cantar himnos",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "El teatro ayuda a expresar emociones, desarrollar el lenguaje y fortalecer la expresión corporal.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál de estos colores expresa energía y entusiasmo en una obra artística?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué tipo de danza es considerada un Patrimonio Cultural de la Nación en Perú?",
        opciones: [
          "La marinera",
          "El reggaetón",
          "La zamba",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "La danza de las tijeras es reconocida como Patrimonio Cultural Inmaterial de la Nación y de la Humanidad.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El cajón y la cajita son instrumentos tradicionales afroperuanos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La marinera se baila con un pañuelo blanco y representa el cortejo amoroso.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál es un tipo de danza típica del pueblo afrodescendiente en Perú?",
        opciones: [
          "Marinera norteña",
          "Zamacueca",
          "Danza de los Pallas",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "La danza de los Negritos es una danza navideña con raíces afroperuanas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Zapateo fuerte, trajes brillantes y acrobacias",
          "Giros con velos",
          "Movimientos solo con los brazos",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "El Caporal incluye saltos, zapateos intensos y trajes vistosos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Una obra de televisión",
          "Una competencia deportiva",
          "Una representación escénica hecha por estudiantes",
          "Una danza tradicional",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "El teatro escolar permite a los estudiantes interpretar obras con personajes y escenografía.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El amarillo y el naranja son colores cálidos que transmiten alegría y energía.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "La cortina que se abre y cierra al empezar o terminar una obra",
          "Un instrumento musical",
        ],
        respuestaCorrecta: 2,
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "¡A escena! es la expresión que da inicio a la presentación teatral.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El festejo se caracteriza por su ritmo rápido y sus movimientos alegres.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Las bandas de Caporales usan trompetas para marcar el ritmo en los desfiles.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "La cultura africana traída por los esclavos",
          "La cultura asiática",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Estas danzas reflejan la identidad cultural africana del Perú costero.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué personaje aparece a veces en la danza de los Caporales con un látigo?",
        opciones: ["El ángel", "El diablo", "El capataz", "El abuelo"],
        respuestaCorrecta: 2,
        explicacion:
          "El capataz aparece como figura dominante con látigo en la danza.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué baile representa el cortejo entre un hombre y una mujer con movimientos delicados?",
        opciones: ["Festejo", "Saya", "Caporales", "Marinera"],
        respuestaCorrecta: 3,
        explicacion:
          "La marinera muestra el galanteo amoroso entre los bailarines con elegancia.",
      },
    ],
  },
  5: {
    Inglés: [
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "I am es la forma correcta. Significa 'yo soy' o 'yo estoy'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Se usa 'an' antes de palabras que empiezan con vocal: an elephant.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La forma negativa es 'I don't like apples' (No me gustan las manzanas).",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "What's your name? pregunta tu nombre, se responde 'My name is...'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "How old are you? es la forma correcta de preguntar la edad.",
      },
    ],
    Matemática: [
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Si una caja tiene 24 lápices y se compran 5 cajas, ¿cuántos lápices hay en total?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Un terreno rectangular mide 25 m de largo y 12 m de ancho. ¿Cuál es su área?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Una persona recorre 3 km cada día durante una semana. ¿Cuántos kilómetros recorre en total?",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La secuencia duplica cada vez: 2 × 2 = 4, 4 × 2 = 8, 8 × 2 = 16.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Si un litro de leche cuesta S/.3.80, ¿cuánto costarán 4 litros?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Un autobús recorre 90 km en 2 horas. ¿Cuál es su velocidad media?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Si tengo 3 billetes de S/.20 y 2 monedas de S/.5, ¿cuánto dinero tengo?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Cuál es la media de los siguientes números: 10, 20, 30, 40, 50?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Una piscina se llena con 80 litros por hora. ¿Cuántos litros se habrán llenado en 6 horas?",
    ...
    Comunicación: [
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Un texto instructivo explica los pasos a seguir para hacer algo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          ...
          "Palabra con igual significado",
          "Palabra inventada",
          "Palabra extranjera",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Un sinónimo es una palabra con significado similar a otra.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        pregunta: "¿Qué es una oración compuesta?",
        opciones: [
          "Una oración con una sola idea",
          "Una oración con dos o más ideas",
          "Una oración interrogativa",
          "Una oración exclamativa",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Las oraciones compuestas contienen más de una idea principal.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál es el sujeto en la oración: 'El perro duerme tranquilo'?",
      ...
      },
      {
        ...
        opciones: [
          "Un texto que da órdenes",
          "Un texto que argumenta",
          "Un texto que informa",
          "Un texto que detalla cómo es algo",
        ],
        respuestaCorrecta: 3,
        explicacion:
          "El texto descriptivo muestra características de personas, lugares o cosas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Los signos de interrogación se usan para formular preguntas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Nombrar una acción",
          "Acompañar al verbo",
          "Describir al sustantivo",
          "Reemplazar al sujeto",
        ],
        respuestaCorrecta: 2,
      ...
      },
      {
        ...
        respuestaCorrecta: 3,
        explicacion:
          "Los sustantivos abstractos nombran ideas, emociones o cualidades.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál de las siguientes palabras es un antónimo de 'alegría'?",
      ...
      },
      {
        ...
        opciones: [
          "Palabras que suenan igual y se escriben igual",
          "Palabras que suenan igual pero se escriben distinto",
          "Palabras diferentes con igual escritura",
          "Palabras extranjeras",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Palabras que suenan igual pero se escriben distinto y tienen diferente significado.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Un texto de opinión",
          "Un resumen",
          "Un texto sobre la vida de una persona",
        ],
        respuestaCorrecta: 3,
      ...
      },
      {
        ...
        opciones: [
          "Un texto que narra",
          "Un texto que da razones para convencer",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El tiempo verbal nos dice si la acción es presente, pasada o futura.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Comprender un texto implica entender sus ideas centrales.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          "Final del texto",
          "Separación de oraciones dentro del mismo párrafo",
          "Inicio de párrafo",
          "Enumeración",
        ],
        respuestaCorrecta: 1,
    ...
    "Ciencia y Tecnología": [
      {
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El termómetro mide la temperatura de un cuerpo o ambiente.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Un organismo que crece, se reproduce y muere",
          "Una roca",
          "El agua",
          "El fuego",
        ],
      ...
      },
      {
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Saturno es conocido por sus anillos formados por hielo y polvo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Una combinación de dos o más sustancias",
          "Una sustancia pura",
          "Un elemento químico",
          "Un metal",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "Las mezclas están formadas por varios componentes unidos sin reacción química.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 0,
        explicacion:
          "La energía hidroeléctrica convierte el movimiento del agua en electricidad.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Aunque vive en el agua, la ballena es un mamífero porque respira aire y amamanta.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Cómo se llama el proceso por el que el agua pasa de gas a líquido?",
        opciones: ["Condensación", "Evaporación", "Sublimación", "Fusión"],
        respuestaCorrecta: 0,
        explicacion:
          "La condensación es el paso de gas (vapor) a estado líquido.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 0,
        explicacion:
          "La hipótesis es una idea que se intenta comprobar con un experimento.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Los ovíparos son los que nacen de huevos, como aves y reptiles.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Que se descompone de forma natural",
          "Que se quema facilmente",
          "Que es muy fuerte",
          "Que es tóxico",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "Los materiales biodegradables se descomponen con el tiempo sin contaminar.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Atrae los objetos hacia el centro de la Tierra",
          "Empuja los objetos hacia arriba",
          "Hace que floten",
      ...
      },
      {
        ...
        opciones: [
          "El material que contiene la información genética",
          "Una enfermedad",
          "Una vitamina",
          "Un metal",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "El ADN contiene las instrucciones para el desarrollo de todos los seres vivos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "La luz del sol se refracta en las gotas de lluvia formando el arcoíris.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El microscopio amplía objetos que no se pueden ver a simple vista.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Al exhalar, eliminamos dióxido de carbono, un gas de desecho.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Reciclar ayuda a reducir la contaminación y el uso de recursos naturales.",
      },
    ],
    "Personal Social": [
      {
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El Perú está ubicado en América del Sur, en la costa occidental.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cómo se llamaba la gran civilización que construyó Machu Picchu?",
        opciones: ["Aztecas", "Mayas", "Incas", "Mochicas"],
        respuestaCorrecta: 2,
        explicacion:
          "Los Incas construyeron Machu Picchu y tuvieron un gran imperio en los Andes.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El río Amazonas es el más largo del mundo y pasa por varios países sudamericanos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "José de la Riva-Agüero fue el primer presidente del Perú en 1823.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El Perú tiene 24 departamentos más la Provincia Constitucional del Callao.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La Independencia del Perú se celebra el 28 de julio, proclamada por San Martín en 1821.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El Océano Pacífico baña toda la costa occidental de Sudamérica, incluyendo Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "La Cordillera de los Andes es la cadena montañosa más larga del mundo y atraviesa el Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El Lago Titicaca está en la Sierra, en la frontera entre Perú y Bolivia.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Cusco fue la capital del Imperio Incaico y se le conocía como el 'ombligo del mundo'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Perú limita con 5 países: Ecuador, Colombia, Brasil, Bolivia y Chile.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El ceviche es el plato bandera del Perú, hecho con pescado crudo marinado en limón.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Respetar las leyes y ayudar a la comunidad",
          "Tener mucho dinero",
          "Vivir solo",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Un buen ciudadano respeta las leyes, participa en la comunidad y ayuda a otros.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Derecho a jugar",
          "Derecho a la vida",
          "Derecho a tener juguetes",
          "Derecho a ver televisión",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "El derecho a la vida es fundamental, de él se derivan todos los demás derechos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué institución protege los derechos de los niños en el Perú?",
        opciones: ["DEMUNA", "Policía", "Bomberos", "Hospital"],
        respuestaCorrecta: 0,
        explicacion:
          "La DEMUNA (Defensoría Municipal del Niño y del Adolescente) protege los derechos infantiles.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál es el símbolo patrio que representa al Perú en el mundo?",
        opciones: [
          "La bandera",
          "El himno",
          "El escudo",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "La bandera, el himno nacional y el escudo son los tres símbolos patrios del Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El pasaporte es el documento oficial que permite viajar a otros países.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El Perú es una República democrática con división de poderes.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "En el Perú, las elecciones presidenciales y congresales se realizan cada 5 años.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál es la principal actividad económica de la Costa peruana?",
        opciones: ["Ganadería", "Pesca", "Minería", "Turismo"],
        respuestaCorrecta: 1,
        explicacion:
          "La pesca es una de las principales actividades económicas de la costa peruana.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El 9 de diciembre se conmemora la Batalla de Ayacucho, que selló la independencia americana.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El cóndor andino es el ave nacional del Perú y símbolo de los Andes.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Democracia significa 'gobierno del pueblo', donde todos pueden participar.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El clima de la costa peruana es seco y templado, con pocas lluvias.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La cultura Nazca construyó las famosas Líneas de Nazca hace más de 1,500 años.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Nuestro principal deber en el colegio es estudiar, aprender y formarnos como personas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué cultura precolombina construyó grandes pirámides en México?",
        opciones: ["Maya", "Inca", "Nazca", "Chavín"],
        respuestaCorrecta: 0,
        explicacion:
          "Los mayas construyeron grandes pirámides como la de Chichén Itzá en México.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué instrumento se usaba en el antiguo Perú para registrar información?",
        opciones: ["Quipu", "Papiro", "Jeroglífico", "Ábaco"],
        respuestaCorrecta: 0,
        explicacion:
          "El quipu era un sistema de cuerdas y nudos usado por los incas para registrar datos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "China es famosa por su Gran Muralla, construida hace siglos para defenderse.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Inti era el dios del Sol, considerado el más importante en la cultura inca.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué civilización es conocida por sus filósofos como Platón y Sócrates?",
        opciones: ["Griega", "Romana", "Egipcia", "China"],
        respuestaCorrecta: 0,
        explicacion:
          "La civilización griega fue cuna de importantes filósofos como Platón y Sócrates.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué cultura americana es conocida por sus cabezas colosales?",
        opciones: ["Olmeca", "Inca", "Azteca", "Chimú"],
        respuestaCorrecta: 0,
        explicacion:
          "Los olmecas son conocidos por sus enormes esculturas de cabezas talladas en piedra.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "África es el continente con más países reconocidos internacionalmente.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Bienes materiales o inmateriales con valor histórico",
          "Comida típica",
          "Lenguaje regional",
          "Religión local",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "El patrimonio cultural incluye monumentos, costumbres y tradiciones valiosas de una sociedad.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Las pirámides de Giza se encuentran en Egipto, cerca de El Cairo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "La cultura Chavín habitó la región andina antes del surgimiento del imperio inca.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Oceanía se encuentra casi completamente en el hemisferio sur.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Una tradición es una costumbre cultural transmitida con el tiempo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué cultura desarrolló el calendario solar más preciso del mundo antiguo?",
        opciones: ["Maya", "Inca", "China", "Egipcia"],
        respuestaCorrecta: 0,
        explicacion:
          "Los mayas tenían un calendario solar muy preciso, usado en la agricultura y religión.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "La India antigua usó un sistema de castas para dividir a la sociedad.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 0,
        explicacion:
          "La arquitectura griega se caracteriza por el uso de columnas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          "Cultura con miles de años de historia",
          "Cultura nueva",
          "Cultura de un siglo",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Las culturas milenarias tienen una larga tradición que se remonta a miles de años.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "París es considerada la capital cultural y artística de Francia.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El carnaval de Río es una festividad cultural emblemática de Brasil.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Las culturas mesopotámicas construían zigurats como templos religiosos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El flamenco es una expresión cultural originaria del sur de España.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El Taj Mahal es un mausoleo considerado una joya arquitectónica india.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Los Chachapoyas vivieron en la ceja de selva del Perú y construyeron Kuélap.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Variedad de culturas en un mismo lugar",
          "Misma cultura",
          "Idioma único",
          "Raza común",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "La diversidad cultural es la existencia de múltiples culturas en una sociedad.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué civilización dominó gran parte de Europa durante siglos?",
      ...
      },
      {
        ...
        respuestaCorrecta: 0,
        explicacion:
          "La democracia fue desarrollada en la antigua Grecia, especialmente en Atenas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Organización que protege el patrimonio cultural",
          "Una universidad",
          "Un partido político",
          "Un libro",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "La UNESCO protege sitios culturales y naturales en el mundo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Principios que guían a una sociedad",
          "Normas escritas",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Los valores culturales son ideas compartidas que orientan el comportamiento social.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Los Moche construyeron templos escalonados como Huaca del Sol y la Luna.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Los Paracas destacaron por sus tejidos complejos y técnicas de momificación.",
      },
    ],
    "Arte y Cultura": [
      {
        ...
        opciones: [
          "Un estilo de música",
          "Una técnica de pintura",
          "La representación de historias mediante actuación",
          "Un tipo de danza tradicional",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "El arte dramático es una forma de arte en la que se representan historias mediante actuaciones teatrales.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "La tela que cubre el escenario",
          "Un personaje teatral",
          "Una técnica de canto",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "El telón es la gran tela que cubre y descubre el escenario antes y después de la función.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta: "¿Qué representa la danza de los Caporales?",
        opciones: [
          "El poder del conquistador español",
          "La lucha afroperuana",
          "La figura del capataz de la hacienda",
          "La vida andina campesina",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "La danza de los Caporales representa al capataz que vigilaba a los esclavos africanos en las haciendas coloniales.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál de los siguientes es un instrumento musical de viento?",
      ...
      },
      {
        ...
        opciones: [
          ...
          "Blanco, negro, gris",
          "Celeste, marrón, rosado",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "Los colores primarios del círculo cromático son rojo, azul y amarillo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Solo música y baile",
          "Improvisación total",
          "Actuación, guión y escenografía",
          "Uso exclusivo de marionetas",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Una obra de teatro se caracteriza por la actuación de actores, un guión y escenografía que ambienta la historia.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Técnica de pintura con colores cálidos",
          "Juego de luces y sombras",
          "Uso de pinturas digitales",
          "Mezcla de texturas",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "El claroscuro es una técnica artística que juega con las luces y sombras para dar profundidad a la obra.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál es la capital cultural del Perú por su tradición artística?",
        opciones: ["Lima", "Arequipa", "Ayacucho", "Cusco"],
        respuestaCorrecta: 2,
        explicacion:
          "Ayacucho es conocida por su gran tradición artística en retablos, música y festividades.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué danza afroperuana representa la herencia africana en el Perú?",
        opciones: ["El caporal", "La marinera", "El festejo", "El huayno"],
        respuestaCorrecta: 2,
        explicacion:
          "El festejo es una danza afroperuana que celebra la herencia africana con mucho ritmo y alegría.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La técnica lineal se basa en el uso de líneas para formar las figuras sin relleno ni color.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "El poder militar",
          "El enfrentamiento de habilidades y resistencia",
          "La fe religiosa",
          "La caza de animales",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "La danza de las Tijeras representa un duelo de habilidades físicas, resistencia y simbolismo cultural andino.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Lento y melancólico",
          "Acelerado y vigoroso",
          "Uniforme y constante",
          "Suelto y libre",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "El caporal se caracteriza por su ritmo acelerado y pasos fuertes y vigorosos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El blanco se asocia tradicionalmente con la paz y la pureza.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué instrumento musical acompaña muchas danzas afroperuanas?",
        opciones: ["Guitarra", "Cajón", "Zampoña", "Trompeta"],
        respuestaCorrecta: 1,
        explicacion:
          "El cajón es un instrumento esencial en muchas danzas afroperuanas como el festejo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta: "¿Qué es un mural?",
        opciones: [
          "Una danza de la selva",
          "Un tipo de teatro",
          "Una pintura hecha sobre una pared",
          "Un instrumento musical tradicional",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Un mural es una pintura de gran tamaño hecha directamente sobre una pared o muro.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué danza representa la alegría del pueblo negro en la costa peruana?",
        opciones: [
          "El huayno",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El festejo es una danza alegre que celebra la herencia afroperuana.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La diablada simboliza la lucha entre el bien (arcángeles) y el mal (diablos).",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Una danza selvática",
          "Una técnica de pintura",
          "Un género teatral con canto y diálogo",
          "Un instrumento tradicional",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "La zarzuela es un género teatral que mezcla actuación con partes cantadas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Leonardo da Vinci pintó 'La Última Cena', una de sus obras más reconocidas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué material se usa en esculturas tradicionales de Ayacucho?",
        opciones: ["Plomo", "Yeso", "Piedra de Huamanga", "Bronce"],
        respuestaCorrecta: 2,
        explicacion:
          "La piedra de Huamanga es muy usada en esculturas religiosas y artísticas ayacuchanas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué ritmo musical tiene origen en Bolivia y se baila también en Perú?",
        opciones: ["Huaylas", "Festejo", "Saya", "Marinera"],
        respuestaCorrecta: 2,
        explicacion:
          "La saya es un ritmo boliviano afroandino que también se baila en zonas del sur del Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La vestimenta del caporal simboliza fuerza, dominio y autoridad sobre los esclavos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué danza peruana es considerada Patrimonio Cultural de la Nación?",
        opciones: ["Festejo", "Caporal", "Marinera", "Tondero"],
        respuestaCorrecta: 2,
        explicacion:
          "La Marinera es reconocida como Patrimonio Cultural por su elegancia y tradición.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Guernica es una obra de Pablo Picasso que representa los horrores de la guerra.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Cálido es más oscuro",
          "Frío solo se usa en acuarelas",
          "Cálidos generan energía, fríos tranquilidad",
          "No existe diferencia",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Los colores cálidos (rojo, naranja) transmiten energía; los fríos (azul, verde) dan calma.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El festejo celebra la cultura afrodescendiente en el Perú.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Los mochicas usaban barro cocido para hacer sus cerámicas expresivas y detalladas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El danzante de tijeras usa dos láminas metálicas que produce sonidos mientras baila.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué técnica artística utiliza pinceles y pigmentos disueltos en agua?",
        opciones: ["Carboncillo", "Témpera", "Óleo", "Acuarela"],
        respuestaCorrecta: 3,
        explicacion:
          "La acuarela es una técnica que usa pigmentos en agua, ideal para lograr transparencias.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué danza representa la alegría de los carnavales en Cajamarca?",
        opciones: ["Carnaval cajamarquino", "Diablada", "Huaylas", "Caporal"],
        respuestaCorrecta: 0,
        explicacion:
          "El carnaval cajamarquino es una danza llena de colores y diversión en la región de Cajamarca.",
      },
    ],
  },
  6: {
    Inglés: [
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El pasado simple de 'go' es 'went'. Es un verbo irregular.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El presente continuo se forma con 'am/is/are + verbo + ing': I am playing.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "'What did you do yesterday?' significa '¿Qué hiciste ayer?'",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "'I was studying' es el pasado continuo que significa 'yo estaba estudiando'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Para preguntar con he/she/it se usa 'does': Where does she live?",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "'I have been to Paris' es presente perfecto y significa 'He estado en París'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "'Can' expresa habilidad en presente: I can swim (puedo/sé nadar).",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El futuro con 'will' se forma: will + verbo base: I will go.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "'How long have you lived here?' significa '¿Cuánto tiempo has vivido aquí?'",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La forma negativa de 'can' es 'can't' o 'cannot': He can't speak English.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cómo se forma una pregunta en pasado simple con verbos regulares?",
        opciones: [
          "Did + you + verbo base",
          "Do + you + verbo",
          "You + verbo + ed",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Las preguntas en pasado simple usan 'did': Did you play soccer?",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "'I would like' es una forma educada de pedir: 'Me gustaría un poco de té'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "No hay diferencia",
          "Much para contables, many para incontables",
          "Many para contables, much para incontables",
          "Much es plural",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "'Many' se usa con sustantivos contables, 'much' con incontables.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "'Used to' expresa hábitos del pasado: She used to play tennis.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "En reported speech, 'am/is' cambia a 'was': He said he was tired.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La voz pasiva en pasado: 'The house was built' (La casa fue construida).",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "'Must' expresa obligación fuerte: You must do it (debes hacerlo).",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "'I wish' + pasado expresa deseos irreales: 'Ojalá pudiera volar'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          ...
          "You are coming, do you?",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Tag question: positivo + negativo: You are coming, aren't you?",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué significa 'He had already left when I arrived' en español?",
        opciones: [
          "Se fue cuando llegué",
          "Se había ido cuando llegué",
          "Se va cuando llego",
          "Se irá cuando llegue",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Past perfect indica una acción anterior a otra en el pasado.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "No hay diferencia",
          "Few es positivo, a few negativo",
          "A few es positivo, few negativo",
          "Few es para incontables",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "'A few' es positivo (algunos), 'few' es negativo (pocos/casi ninguno).",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "'Must' expresa probabilidad fuerte: He must be at home (debe estar en casa).",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "Ambas formas son correctas para expresar acuerdo negativo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
    ...
    Matemática: [
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Un terreno rectangular mide 28 m de largo y 15 m de ancho. ¿Cuál es su área?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Una botella tiene 1.25 litros y se llena 8 veces. ¿Cuántos litros en total?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Cuál es el perímetro de un triángulo con lados 12 cm, 9 cm y 10 cm?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Un recipiente contiene 4.25 litros. Si se reparte en botellas de 0.5 litros, ¿cuántas botellas se llenan?",
        opciones: ["8", "9", "10", "11"],
        respuestaCorrecta: 1,
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Si una camisa cuesta S/ 54 y hay 15% de descuento, ¿cuánto se paga?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Si un rectángulo mide 12 cm de largo y 5 cm de ancho, ¿cuál es su perímetro?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Si un ángulo mide 130°, ¿cuánto le falta para ser un ángulo llano?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Cuál es el área de un triángulo de base 10 cm y altura 8 cm?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "Un producto cuesta S/ 120 y tiene un 25% de descuento. ¿Cuánto se paga?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué número tiene 3 decenas de mil, 4 centenas y 5 unidades?",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Cuál es el número que al multiplicarse por sí mismo da 225?",
    ...
    Comunicación: [
      {
        ...
        respuestaCorrecta: 0,
        explicacion:
          "'Feliz' y 'triste' son antónimos porque significan lo contrario.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El cuento es un texto narrativo que relata una historia con personajes y trama.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          "El momento en que ocurre la acción",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El tiempo verbal muestra si la acción es presente, pasado o futuro.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Un texto que da pasos para realizar algo",
          "Un poema",
          "Una noticia",
          "Una leyenda",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "Los textos instructivos explican cómo hacer algo, como una receta o manual.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        opciones: [
          "Combina hechos reales con elementos fantásticos",
          "Tiene solo datos científicos",
          "Es una carta",
          "Es solo una opinión",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "Las leyendas mezclan realidad con ficción, como en la leyenda del tunche.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El sujeto es la parte de la oración que realiza la acción del verbo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta: "¿Qué es un diálogo?",
        opciones: [
          "Intercambio de palabras entre dos o más personas",
          "Un monólogo",
          "Un resumen",
          "Una descripción",
        ],
      ...
      },
      {
        ...
        pregunta: "¿Qué es un resumen?",
        opciones: [
          "Una versión corta de un texto con lo más importante",
          "Un poema rimado",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El resumen recoge las ideas principales de un texto en pocas palabras.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál es la diferencia entre narrador protagonista y omnisciente?",
        opciones: [
          "El protagonista cuenta su historia; el omnisciente conoce todo",
          "Ambos son iguales",
          "El omnisciente no existe",
          "Ninguno narra",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "El protagonista narra en primera persona; el omnisciente narra en tercera y lo sabe todo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El texto argumentativo presenta ideas y razones para convencer al lector.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Un texto para comunicarse con autoridades o instituciones",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Una carta formal tiene un lenguaje serio y se usa en situaciones oficiales.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Usar solo palabras largas",
          "Tener muchas páginas",
          "Rimar cada oración",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "Un texto coherente tiene ideas que se conectan lógicamente.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "El que describe personas, objetos o lugares",
          "El que explica fórmulas",
          "El que da órdenes",
          "El que narra aventuras",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "El texto descriptivo presenta cómo es algo usando detalles.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "En la entrevista hay un entrevistador que hace preguntas y un entrevistado que responde.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "La noticia debe informar sobre qué ocurrió, cuándo y dónde.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Un poema en el que las letras iniciales forman una palabra",
          "Un cuento",
          "Una definición",
          "Un texto científico",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "El acróstico es un poema especial en que las letras iniciales forman una palabra clave.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Expresión propia de una región",
          "Palabra extranjera",
          "Palabra inventada",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Un modismo es una expresión típica como 'tirar la toalla'.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El ADN contiene las instrucciones genéticas necesarias para el desarrollo y funcionamiento de los seres vivos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Una célula con núcleo definido",
          "Una célula con pared celular",
          "Una célula unicelular",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Las células eucariotas tienen núcleo definido y organelos rodeados por membranas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "La primera ley de Newton dice que un cuerpo en reposo o en movimiento rectilíneo uniforme se mantendrá así si no hay una fuerza externa.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "Una planta hidroeléctrica convierte la energía del agua en energía eléctrica.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El gen es la unidad básica de herencia y está compuesto por ADN.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál de estos materiales es un buen conductor de electricidad?",
      ...
      },
      {
        ...
        opciones: [
          ...
          "Proceso por el cual las plantas fabrican su alimento",
          "Formación de raíces",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Es el proceso por el que las plantas convierten la luz solar en alimento.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Controlar la entrada de sustancias",
          "Producir energía",
          "Almacenar agua",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La mitocondria es responsable de la respiración celular y la producción de energía (ATP).",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué fenómeno ocurre cuando la luz cambia de dirección al pasar de un medio a otro?",
        opciones: ["Reflexión", "Absorción", "Difracción", "Refracción"],
        respuestaCorrecta: 3,
        explicacion:
          "La refracción es el cambio de dirección de la luz al pasar de un medio a otro con distinta densidad.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "Durante la respiración celular se libera dióxido de carbono como producto de desecho.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El páncreas libera insulina, que regula los niveles de glucosa en la sangre.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La corteza terrestre es la capa más externa y está formada por rocas sólidas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Regular la temperatura",
          "Transportar oxígeno",
          "Defender el cuerpo de enfermedades",
          "Producir hormonas",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "El sistema inmunológico defiende al cuerpo de agentes patógenos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El microscopio permite observar estructuras celulares invisibles a simple vista.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El CO₂ es uno de los principales gases causantes del efecto invernadero.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La batería almacena energía química que se transforma en energía eléctrica.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Una célula que produce leche",
          "Una célula que transporta oxígeno",
          "Una célula capaz de transformarse en otros tipos de células",
          "Una célula del sistema digestivo",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Las células madre pueden convertirse en distintos tipos celulares.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Los imanes atraen ciertos metales como el hierro y el níquel.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Una conclusión",
          "Un experimento",
          "Una predicción basada en observaciones",
          "Un dato exacto",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Es una suposición que se puede comprobar mediante la experimentación.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Las células vegetales poseen pared celular que les da rigidez y protección.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La velocidad indica el cambio de posición por unidad de tiempo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Los riñones filtran los desechos de la sangre y forman la orina.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué órgano permite el intercambio de oxígeno y dióxido de carbono?",
        opciones: ["Estómago", "Corazón", "Pulmones", "Riñones"],
        respuestaCorrecta: 2,
        explicacion:
          "Los pulmones permiten el intercambio gaseoso durante la respiración.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La clorofila captura la luz solar para realizar la fotosíntesis.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué efecto tiene una fuerza no equilibrada sobre un objeto?",
        opciones: [
          "Lo mantiene quieto",
          "Cambia su dirección o velocidad",
          "Lo rompe",
          "No tiene efecto",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Una fuerza no equilibrada cambia el movimiento del objeto.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué tipo de célula tiene un solo núcleo y muchas funciones?",
        opciones: ["Neurona", "Hepatocito", "Bacteria", "Glóbulo rojo"],
        respuestaCorrecta: 1,
        explicacion:
          "Los hepatocitos (células del hígado) tienen muchas funciones metabólicas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "Las corrientes de convección del manto causan el movimiento de placas tectónicas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Ecosistema es la interacción entre seres vivos y el ambiente.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
    ...
    "Ciencia y Tecnología": [
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Saturno es famoso por sus anillos que se pueden observar con telescopios.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La energía eólica se produce a partir del movimiento del viento.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué sistema del cuerpo humano se encarga de la respiración?",
        opciones: ["Circulatorio", "Digestivo", "Respiratorio", "Nervioso"],
        respuestaCorrecta: 2,
        explicacion:
          "El sistema respiratorio se encarga de captar oxígeno y expulsar dióxido de carbono.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El cuerpo expulsa dióxido de carbono como desecho de la respiración.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué parte del cuerpo se conecta con el sistema nervioso para permitirnos pensar?",
        opciones: ["Cerebro", "Corazón", "Estómago", "Hígado"],
        respuestaCorrecta: 0,
        explicacion:
          "El cerebro controla el pensamiento y las funciones corporales.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué recurso natural es indispensable para la vida y cubre gran parte de la Tierra?",
      ...
      },
      {
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El termómetro mide la temperatura en grados Celsius o Fahrenheit.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Marte recibe ese nombre por el color rojizo de su superficie.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué nombre recibe el movimiento de la Tierra sobre su propio eje?",
        opciones: ["Rotación", "Traslación", "Órbita", "Revolución"],
        respuestaCorrecta: 0,
        explicacion:
          "La rotación es el giro de la Tierra sobre su propio eje y dura 24 horas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "La energía solar proviene directamente de la radiación del Sol.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El oxígeno es el gas necesario para la respiración de los seres humanos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Cómo se llama el proceso en el que el agua se convierte en vapor?",
        opciones: [
          "Evaporación",
          "Condensación",
          "Precipitación",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué parte de la planta se encarga de realizar la fotosíntesis?",
        opciones: ["Raíz", "Tallo", "Hojas", "Semillas"],
        respuestaCorrecta: 2,
        explicacion:
          "Las hojas realizan la fotosíntesis gracias a la clorofila.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Venus tiene una atmósfera muy densa con nubes de ácido sulfúrico.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué nombre recibe el proceso en el que las nubes producen lluvia?",
        opciones: [
          "Evaporación",
          "Condensación",
          "Precipitación",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Los peces respiran oxígeno disuelto en el agua mediante branquias.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué órgano humano se encarga de la digestión principal de los alimentos?",
        opciones: ["Estómago", "Pulmones", "Intestino grueso", "Corazón"],
        respuestaCorrecta: 0,
        explicacion:
          "El estómago descompone los alimentos con jugos gástricos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cómo se llama el proceso en el que las plantas liberan oxígeno?",
        opciones: [
          "Respiración",
          "Fotosíntesis",
          "Polinización",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Durante la fotosíntesis, las plantas producen oxígeno como desecho.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El microscopio permite ver células y otros objetos diminutos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué planeta tiene una gran mancha roja que es una tormenta gigante?",
        opciones: ["Saturno", "Neptuno", "Júpiter", "Marte"],
        respuestaCorrecta: 2,
        explicacion:
          "Júpiter tiene la Gran Mancha Roja, una tormenta de más de 300 años.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Las arterias y venas transportan la sangre en el sistema circulatorio.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        respuestaCorrecta: 1,
        explicacion:
          "La Tierra tarda 365 días en completar su traslación alrededor del Sol.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El eclipse solar ocurre cuando la Luna se interpone entre la Tierra y el Sol.",
      },
    ],
    ...
    "Personal Social": [
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué imperio fue conocido por sus conquistas y por haber extendido el cristianismo por Europa?",
        opciones: [
          "Imperio Romano",
          "Imperio Otomano",
          "Imperio Persa",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El Imperio Romano se destacó por sus conquistas militares y por difundir el cristianismo en Europa.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Un sistema social y político de la Edad Media",
          "Una forma de gobierno democrático",
          "Una religión medieval",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "El feudalismo fue un sistema en el que los señores feudales controlaban tierras y protegían a los campesinos a cambio de trabajo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué cultura europea impulsó el Renacimiento en los siglos XV y XVI?",
        opciones: [
          "La cultura griega",
          "La cultura egipcia",
          "La cultura italiana",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El Renacimiento comenzó en Italia e impulsó el arte, la ciencia y el pensamiento humanista.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué país lideró la conquista de gran parte de América en el siglo XVI?",
        opciones: ["Portugal", "España", "Francia", "Inglaterra"],
        respuestaCorrecta: 1,
        explicacion:
          "España fue el principal imperio colonizador en América tras la llegada de Colón en 1492.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Guerras religiosas entre cristianos y musulmanes",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Las Cruzadas fueron expediciones cristianas para recuperar Tierra Santa de los musulmanes.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Las invasiones de pueblos bárbaros como los visigodos causaron la caída del Imperio en 476 d.C.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Ciudades griegas",
          "Territorios conquistados y dominados por un país extranjero",
          "Religiones antiguas",
          "Rutas comerciales",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Las colonias eran territorios dominados por potencias como España, Inglaterra o Francia.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Carlos I y Juana la Loca",
          "Fernando e Isabel",
          "Napoleón y Josefina",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Los Reyes Católicos de España, Fernando e Isabel, financiaron a Colón en 1492.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Inició la democracia moderna",
          "Apoyó el feudalismo",
          "Creó nuevos imperios",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "La Revolución Francesa dio paso a ideas de igualdad, libertad y derechos ciudadanos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Un rey español",
          "Un libertador de América del Sur",
          "Un emperador romano",
          "Un sacerdote maya",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Bolívar luchó por la independencia de varios países de Sudamérica del dominio español.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué cultura fue conocida por su escritura jeroglífica y sus pirámides?",
        opciones: ["Los griegos", "Los romanos", "Los egipcios", "Los chinos"],
        respuestaCorrecta: 2,
        explicacion:
          "Los egipcios desarrollaron los jeroglíficos y construyeron pirámides como tumbas reales.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Un campesino sin tierras",
          "Un sacerdote",
          "Un noble que controlaba tierras y siervos",
          "Un comerciante de la Edad Media",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Los señores feudales eran dueños de tierras y tenían siervos a su cargo en la Edad Media.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Napoleón fue un militar francés que se convirtió en emperador y conquistó gran parte de Europa.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Un movimiento de ideas sobre la razón, ciencia y libertad",
          "Una religión antigua",
          "Una colonia inglesa",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "La Ilustración fue un movimiento intelectual que defendía la razón y el conocimiento científico.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El descubrimiento de América permitió el encuentro de dos mundos: Europa y América.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "Hernán Cortés conquistó el Imperio Azteca con ayuda de pueblos indígenas aliados.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué civilización dominó gran parte del norte de África y el Mediterráneo?",
        opciones: ["Los incas", "Los romanos", "Los sumerios", "Los griegos"],
        respuestaCorrecta: 1,
        explicacion:
          "El Imperio Romano controló vastos territorios del norte de África y Europa.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Una guerra europea",
          "Una epidemia que mató a millones en la Edad Media",
          "Un invento de los árabes",
          "Una batalla en Egipto",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "La peste negra fue una pandemia que mató a millones en Europa durante el siglo XIV.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "España conquistó el Imperio Inca y colonizó el territorio peruano en 1532.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué sistema usaron los incas para gobernar sus territorios?",
        opciones: [
          "Feudalismo",
          "Democracia",
          "Centralismo con caminos y chasquis",
          "Reinos independientes",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "El Imperio Inca usaba caminos, quipus y chasquis para controlar su extenso territorio.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Solo los hechos de América",
          "Eventos pasados de todo el mundo",
          "Solo culturas peruanas",
          "Inventos modernos",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "La historia universal estudia eventos importantes ocurridos en diferentes continentes y épocas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Por qué los españoles tenían ventaja en la conquista del Perú?",
        opciones: [
          "Tenían armas modernas y aliados indígenas",
          "Hablaban quechua",
          "Respetaban las culturas locales",
          "Eran más numerosos",
        ],
        respuestaCorrecta: 0,
        explicacion:
          "Los españoles usaban armas de fuego y aprovecharon conflictos internos entre los incas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El descubrimiento de América en 1492 marca el inicio de la Edad Moderna.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Durante las Cruzadas, los europeos buscaron recuperar Jerusalén de manos de los musulmanes.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Machu Picchu fue construida por los incas en el siglo XV.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Una época entre la Prehistoria y la Edad Antigua",
          "Un periodo de guerras y castillos entre los siglos V y XV",
          "Una etapa de paz en Europa",
          "Un imperio del pasado",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "La Edad Media fue un periodo entre la caída del Imperio Romano y el Renacimiento.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué sistema político dominaba en Europa durante la Edad Media?",
        opciones: [
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El feudalismo organizaba la sociedad en señores, vasallos y siervos.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál fue la causa principal de la conquista del Tahuantinsuyo?",
        opciones: [
          "El avance tecnológico de los incas",
          "La alianza con los españoles",
          "La guerra civil entre Huáscar y Atahualpa",
          "La ayuda de los mayas",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "La guerra civil debilitó al Imperio Inca y facilitó la conquista española.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "Gengis Kan fue el gran líder del Imperio Mongol, uno de los más extensos de la historia.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál fue uno de los efectos del colonialismo europeo en América?",
        opciones: [
          "El crecimiento de las culturas indígenas",
          "El respeto por las lenguas originarias",
          "La desaparición de muchas culturas nativas",
          "La independencia inmediata de los países",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "El colonialismo provocó la destrucción de muchas culturas indígenas en América.",
      },
    ],
    "Arte y Cultura": [
      {
        ...
        respuestaCorrecta: 0,
        explicacion:
          "El color azul suele asociarse con la calma, la tranquilidad y la tristeza en el arte.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué danza afroperuana se caracteriza por el uso del cajón y movimientos sensuales?",
        opciones: ["Marinera", "Festejo", "Valicha", "Caporal"],
        respuestaCorrecta: 1,
        explicacion:
          "El festejo es una danza afroperuana alegre, con mucho ritmo y uso del cajón peruano.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "'La noche estrellada' es una de las obras más famosas de Van Gogh, pintada en 1889.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Cuál es un instrumento musical de viento originario de los Andes?",
        opciones: ["Charango", "Cajón", "Quena", "Zampoña"],
        respuestaCorrecta: 2,
        explicacion:
          "La quena es un instrumento andino hecho de caña o hueso que se toca soplando por un extremo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El teatro musical mezcla actuación con canciones y coreografías.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "La monocromía se refiere a obras hechas con un solo color o tonos del mismo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué ritmo musical originario de Brasil es muy popular en carnavales?",
        opciones: ["Tango", "Cueca", "Samba", "Cumbia"],
        respuestaCorrecta: 2,
        explicacion:
          "La samba es una danza tradicional brasileña, llena de energía y colores.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué danza boliviana es muy conocida y se baila con trajes brillantes y máscaras?",
        opciones: ["Saya", "Diablada", "Tobas", "Caporales"],
        respuestaCorrecta: 1,
        explicacion:
          "La diablada es una danza tradicional de Oruro con trajes llamativos y temática religiosa.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué danza peruana se baila con pañuelos y es un símbolo de coquetería?",
        opciones: ["Huayno", "Marinera", "Tondero", "Festejo"],
        respuestaCorrecta: 1,
        explicacion:
          "La marinera es considerada la danza nacional del Perú, representando el cortejo entre una pareja.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué obra es considerada el primer dibujo humano en la historia?",
        opciones: [
          "Mona Lisa",
          "Guernica",
        ...
        respuestaCorrecta: 3,
        explicacion:
          "Las pinturas rupestres hechas en cuevas como las de Altamira muestran dibujos de hace miles de años.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Solo bailarines",
          "Música clásica",
          "Actores, escenografía y guion",
          "Instrumentos musicales",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Una obra de teatro necesita guion, actores, vestuario y escenografía.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          ...
          "Una obra musical larga y compleja",
          "Un paso de baile",
          "Una técnica de pintura",
        ],
        respuestaCorrecta: 1,
        explicacion:
          "Una sinfonía es una obra musical compleja compuesta por varios movimientos, generalmente para orquesta.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El violín da el ritmo y melodía al huayno, una danza popular andina.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
      ...
      },
      {
        ...
        competencia: "competencia1",
        pregunta:
          "¿Qué estilo artístico se caracteriza por líneas rectas y tecnología?",
        opciones: ["Cubismo", "Renacimiento", "Arte digital", "Futurismo"],
        respuestaCorrecta: 3,
        explicacion:
          "El futurismo muestra movimiento, máquinas y velocidad, con líneas modernas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        pregunta:
          "¿Qué se celebra en los carnavales peruanos con música y danza?",
        opciones: [
          "Pascua",
          "La cosecha",
          "La fertilidad y alegría",
          "El Día del maestro",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Los carnavales celebran la alegría, la abundancia y la unión del pueblo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 1,
        explicacion:
          "El charango es típico del altiplano, hecho a veces de caparazón de armadillo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        opciones: [
          "Un instrumento musical",
          "Una obra de teatro",
          "Una pintura grande en una pared",
          "Un baile en grupo",
        ],
        respuestaCorrecta: 2,
        explicacion:
          "Los murales son pinturas que se hacen sobre muros o paredes, generalmente públicas.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Los colores primarios no se pueden formar mezclando otros colores: rojo, azul y amarillo.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 0,
        explicacion:
          "Miguel Ángel fue escultor y pintor del Renacimiento, autor de la Capilla Sixtina.",
      },
      {
        dificultad: "facil",
        competencia: "competencia1",
        ...
        respuestaCorrecta: 2,
        explicacion:
          "El caporal es una danza del altiplano boliviano y peruano, con vestimenta pesada y vigorosa.",
      },
    ],
  },
...
(function normalizarBancoPreguntas() {
  if (typeof bancoPreguntas !== "object" || bancoPreguntas === null) {
    console.warn(
      "[preguntas.js] bancoPreguntas no encontrado para normalizar."
    );
    return;
  }
  ...
  Object.keys(bancoPreguntas).forEach((gradoKey) => {
    ...
    Object.keys(grado).forEach((materia) => {
      ...
      arr.forEach((q, idx) => {
        ...
        if (
          typeof q.respuestaCorrecta === "undefined" &&
          typeof q.respuesta !== "undefined"
        ) {
          const r = q.respuesta;
          if (typeof r === "number" || (!isNaN(Number(r)) && r !== "")) {
            ...
            const found = q.opciones.findIndex(
        ...
        if (
          ...
          if (
            q.respuestaCorrecta < 0 ||
            q.respuestaCorrecta >= q.opciones.length
          )
            q.respuestaCorrecta = 0;
        }
        ...
        if (typeof q.pregunta === "undefined")
          q.pregunta = "Pregunta sin texto";
